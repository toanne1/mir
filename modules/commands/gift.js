...
module.exports.onLoad = async() => {
    ...
    const path = resolve(__dirname, 'cache/canvas', 'gift2.png');
...
async function makeImage({ one, two }) {
    ...
    let batgiam_img = await jimp.read(__root + "/gift2.png");
    let pathImg = __root + `/gift2{one}_${two}.png`;
    ...
    batgiam_img.resize(720, 720).composite(circleOne.resize(190, 190), 450, 80).composite(circleTwo.resize(190, 190), 100, 70);
