...
module.exports.onLoad = function() {
    ...
    log("- Hãy report những người có hành động như vậy cho Admin.", '[ ANTIOUT ]');
}
...
module.exports.run = async function({ api, event }) {
    ...
    if (antiout[threadID] == true) {
        ...
        api.sendMessage("Đã tắt chế độ antiout.", threadID, messageID);
    } else {
        antiout[threadID] = true;
        api.sendMessage("Đã bật thành công antiout", threadID, messageID);
    }
